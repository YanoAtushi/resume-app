...
import { formatJpDate, formatPeriod } from "../dateUtils";
    ...
    <div className="preview-sheet" id="resume-preview">
      ...
      <div className="preview-basic">
        ...
        <div className="preview-contact">
          {data.birthDate && <div>生年月日: {formatJpDate(data.birthDate)}</div>}
          ...
          {data.experiences.map((exp, i) => (
            <div key={i} className="preview-entry">
              <div className="preview-entry-head">
                ...
                <span className="preview-entry-period">
                  {formatPeriod(exp.startDate, exp.endDate, exp.current, exp.period)}
                </span>
              </div>
          ...
          {data.education.map((edu, i) => (
            <div key={i} className="preview-entry">
              <div className="preview-entry-head">
                ...
                <span className="preview-entry-period">
                  {formatPeriod(edu.startDate, edu.endDate, edu.current, edu.period)}
                </span>
              </div>
